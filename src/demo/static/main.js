...
function start_file_send()
{
		...
		var chunk_size=1920; // for asr chunk_size [5, 10, 5]
...
function getLanguage(){
  var obj = document.getElementById("varLang");
...
function get_conversationId(){
  var obj = document.getElementById("conversationId");
...
function getJsonMessage( jsonMsg ) {
	...
	if(JSON.parse(jsonMsg.data)['sentenceEnd']==true)
	{
		var rectxt=""+JSON.parse(jsonMsg.data)['text'];
	}
	else
	...
	if(asrmodel=="2pass-offline" || asrmodel=="offline")
	{
		...
		offline_text=offline_text+rectxt; //rectxt; //.replace(/ +/g,"");
